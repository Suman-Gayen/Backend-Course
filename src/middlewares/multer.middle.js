...
const storage = multer.diskStorage({
  // The diskStorage function is used to define the storage engine. It takes an object with two properties: destination and filename.
  destination: function (req, file, cb) {
    // The destination property is used to define the folder where the file will be saved.
  ...
  filename: function (req, file, cb) {
    // The filename property is used to define the name of the file.
